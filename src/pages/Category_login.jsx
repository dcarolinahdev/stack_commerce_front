...
>
  ...
  <option value="Tablets and Smartwatches">Tablets and Smartwatches</option>
</select>
...
<a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="https://www.homecrux.com/wp-content/gallery/smart-mirror/smart-mirror-1.jpg" alt=""/>
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Smart Mirror 2.0</h5>
        
        <span className="text-3xl font-bold ml-12 text-gray-900 dark:text-white">$599</span>
