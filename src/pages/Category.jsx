...
<section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div className="flex flex-col justify-center">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Stack-Ecommerce</h1>
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">"Discover a world of possibilities with our exquisite collection. Elevate your style, redefine your space, and indulge in the art of luxury shopping. Unveil the extraordinary – shop now and transform the ordinary into the extraordinary!"</p>
   ...
   <div  className='lg:flex lg:justify-around  '>
    ...
    <a href="#">
        <img className="p-[28%] pt-8 rounded-t-lg " src="https://www.homecrux.com/wp-content/gallery/smart-mirror/smart-mirror-1.jpg" alt="product image" />
    </a>
    <div className="px-5 pb-8 ">
        <a href="#">
            <h5 className=" mt-[-28%] text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
        </a>
